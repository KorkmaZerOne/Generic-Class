...
public interface DuoUtility {
	...
	public static void printSum(Duo<? extends Number> d1 , Duo<? extends Number> d2) {
		...
		Number n2 = d2.getSecond();
		Number n3 = d2.getFirst();
		Number n4 = d2.getSecond();
		
		System.out.println(n1 + " + " + n2 + " + " + n3 + " + " + n4 + " = " + 
						  (n1.doubleValue() + n2.doubleValue()) + n3.doubleValue() + n4.doubleValue() + "\n");
	}
	...
	public static <T1 extends Number , T2 extends Number> void 
	printSumMixed(Duo<T1> d1 , Duo<T1> d2 , Duo<T2> d3 , Duo<T2> d4) {
		Number n1 = d1.getFirst();
		Number n2 = d1.getSecond();
		Number n3 = d2.getFirst();
		Number n4 = d2.getSecond();
		...
		System.out.println(n1 + "+" + n2 + "+" + n3 + "+" + n4 + "+" + n5 + "+" + n6 + "+" + n7 + "+" + n8 + " = " + 
						  (n1.doubleValue() + n2.doubleValue() + n3.doubleValue() + n4.doubleValue() +
						   n5.doubleValue()+ n6.doubleValue() + n7.doubleValue() + n8.doubleValue()));
